...
SUBMIT_SUGGESTED_EVALUATION = {
    "name": "submit_suggested_evaluation",
    "description": (
        "Submit your assessment of the author's suggested reference(s). Call this "
        "exactly once. Keep one entry per suggestion that resolves to a real paper, "
        "scored for how directly it supports the claim; list suggestions you could "
        "not resolve under \"unresolved\"; never substitute a different paper for "
        "an author's suggestion (offer it under \"alternatives\" instead)."
    ),
    "input_schema": {
        "type": "object",
        "properties": {
            "selected": {
                "type": "array",
                "description": "One entry per suggested reference, in the order listed",
                "items": {
                    "type": "object",
                    "properties": {
                        "suggestion": {"type": "string",
                                       "description": "The suggestion exactly as listed, e.g. 'PMID: 32879322' "
                                                      "or 'Battison 2024'; 'REF' for an additional reference "
                                                      "the author asked you to find"},
                        "pmid": {"type": "string", "default": ""},
                        "doi": {"type": "string", "default": ""},
                        "title": {"type": "string", "default": ""},
                        "score": {"type": "integer", "minimum": 0, "maximum": 100,
                                  "description": "How directly the paper supports the claim"},
                        "why": {"type": "string",
                                "description": "How this paper supports (or fails to support) the claim"},
                    },
                    "required": ["suggestion", "score", "why"],
                },
            },
            "unresolved": {
                "type": "array",
            ...
            "alternatives": {
                "type": "array",
                "description": "Better papers to offer the author (never substituted)",
                "items": {
                    "type": "object",
                    "properties": {
                        "pmid": {"type": "string", "default": ""},
...
FINAL_TOOL_NAMES = {SUBMIT_CITATIONS["name"], SUBMIT_SUGGESTED_EVALUATION["name"],
                    SELECT_CITATIONS["name"], RECORD_VERDICT["name"]}
